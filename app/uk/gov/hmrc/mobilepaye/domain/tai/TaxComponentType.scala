...
sealed trait TaxComponentType extends EnumEntry

object TaxComponentType extends Enum[TaxComponentType] with PlayJsonEnum[TaxComponentType] {
  override def values: immutable.IndexedSeq[TaxComponentType] = {
    findValues ++ AllowanceComponentType.values ++
      BenefitComponentType.values ++ DeductionComponentType.values ++
      IncomeComponentType.values
  }
}
...
object AllowanceComponentType extends Enum[AllowanceComponentType] with PlayJsonEnum[AllowanceComponentType] {
  ...
  override def values: immutable.IndexedSeq[AllowanceComponentType] = findValues
}

object DeductionComponentType extends Enum[DeductionComponentType] with PlayJsonEnum[DeductionComponentType] {
  ...
  override def values: immutable.IndexedSeq[DeductionComponentType] = findValues
}

object TaxCodeIncomeComponentType extends Enum[TaxCodeIncomeComponentType] with PlayJsonEnum[TaxCodeIncomeComponentType] {
  ...
  override def values: immutable.IndexedSeq[TaxCodeIncomeComponentType] = findValues
}

object BenefitComponentType extends Enum[BenefitComponentType] with PlayJsonEnum[BenefitComponentType] {
  ...
  override def values: immutable.IndexedSeq[BenefitComponentType] = findValues
}

object NonTaxCodeIncomeComponentType extends Enum[NonTaxCodeIncomeComponentType] with PlayJsonEnum[NonTaxCodeIncomeComponentType] {
  ...
  override def values: immutable.IndexedSeq[NonTaxCodeIncomeComponentType] = findValues
}
